...
class TitleScrollNavigation extends StatefulWidget {
  ...
  TitleScrollNavigation({
    ...
    required this.pageChangeCurrentIndex,
  ...
  final void Function(int) pageChangeCurrentIndex;
...
class _TitleScrollNavigationState extends State<TitleScrollNavigation> {
  ...
  void _scrollListener() {
    ...
    if (current != _currentPage) {
      ...
      widget.pageChangeCurrentIndex(_currentPage);
    }
  }
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Center(child: _buildScrollTitles()),
          ),
          Expanded(
            child: ClipRRect(
